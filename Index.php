    ...
    <main>
        ...
        <section class="site-title">
            <div class="site-background">
                ...
                <div class="move-up" onClick="document.getElementById('middle').scrollIntoView();">
                    <button class="btn"><i class="fa-arrow-down">Explore</i></button>
                </div>
                ...
                <div class="container">
                    <div class="owl-carousel owl-theme blog-post">
                        ...
                        <div class="blog-content" data-aos="fade-in" data-aos-delay="200">
                            <img src="./assets/Blog-post/post-3.png" alt="post-1">
                            <div class="blog-title">
                                <h3>Some Product</h3>
                                <button class="btn btn-blog">Explore</button>
                                <span>2 minutes</span>
                        ...
                        <div class="blog-content" data-aos="fade-left" data-aos-delay="200">
                            <img src="./assets/Blog-post/post-2.jpeg" alt="post-1">
                            <div class="blog-title">
                                <h3>Some Product</h3>
                                <button class="btn btn-blog">Explore</button>
                                <span>2 minutes</span>
